...
for RIS = 2
    ...
    for cc = 1:n_chan
        ...
        data_location = strcat('E:\KTTT\UAV-RIS-trajactory-main\UAV-RIS-trajactory-main\channels\',num2str(sys.N0)); %mkdir(data_location);
        file_name = strcat(data_location,'\small_scale',num2str(cc),'.mat');
        data = load(file_name);
