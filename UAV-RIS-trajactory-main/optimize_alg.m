...
if RIS == 0
    file_name = strcat('E:\KTTT\UAV-RIS-trajactory-main\UAV-RIS-trajactory-main\channels\',num2str(32),'\small_scale',num2str(cc),'.mat');
else
    file_name = strcat('E:\KTTT\UAV-RIS-trajactory-main\UAV-RIS-trajactory-main\channels\',num2str(sys.N),'\small_scale',num2str(cc),'.mat');
end
data = load(file_name);
    ...
    if opt_tra == 1
        if RIS == 0
            [obj_traj(ii,cc),v_new,v0hat_new,v0check_new] = ...
                opt_traj_noRIS_firefly(v_old,v0hat_old,v0check_old,b_old,sys,cons);
        else
